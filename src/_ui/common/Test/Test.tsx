    ...
    return <div className={styles.container}>
        ...
        <div className={styles.innerBlock}>
            ...
            <div className={styles.checkboxBlock}>
                <Checkbox checked={checkboxValue[0]} onClick={() => onClickCheckbox(0)}>Active default</Checkbox>
                <Checkbox checked={checkboxValue[1]} onClick={() => onClickCheckbox(1)}>Completed default</Checkbox>
                <Checkbox color={'red'} checked={checkboxValue[2]} onClick={() => onClickCheckbox(2)}>Completed customized</Checkbox>
            </div>
            <div className={styles.checkboxBlock}>
                <Checkbox checked={checkboxValue[3]} onClick={() => onClickCheckbox(3)} disabled>Disabled active</Checkbox>
                <Checkbox checked={checkboxValue[4]} onClick={() => onClickCheckbox(4)} disabled>Disabled completed</Checkbox>
            </div>
        </div>
        ...
        <div className={styles.innerBlock}>
            ...
            <div className={styles.checkboxBlock}>
                <Radio color='green' checked={radioSelect[0]} onClick={() => onClickRadio(0)}>Yes</Radio>
                <Radio checked={radioSelect[1]} onClick={() => onClickRadio(1)}>Maybe</Radio>
                <Radio color='red' checked={radioSelect[2]} onClick={() => onClickRadio(2)}>No</Radio>
            </div>
            <div className={styles.checkboxBlock}>
